...
public class ApplicationExtensionAdapter implements ExtensionAdapter<ApplicationClient> {
	...
	public ApplicationClient adapt(Client client) {
            return new DefaultApplicationClient(client.adapt(OkHttpClient.class), client.getConfiguration());
	}
